...
// Your code here ...
funnyHeadline1.includes('oxygen') ? console.log(`The string includes the word 'oxygen'`) : console.log(`The string does not include the word 'oxygen'`);

// Check the second headline
// Your code here ...
funnyHeadline2.includes('oxygen') ? console.log(`The string includes the word 'oxygen'`) : console.log(`The string does not include the word 'oxygen'`);
...
// Your code here ...
let long = string4.length;
console.log(long);

// b) Print the last character in the string
// Your code here ...
console.log(string4[long - 1]);